...
import { type ChangeEvent, useEffect, useRef, type FC } from "react";
...
import { useCurrentPage } from "@shared/model/paginationStore";
...
export const ProgramsPage: FC = () => {
  ...
  return (
    <BuyItemBlock>
      <MainTitle title="Программы тренировок" />
      ...
      <ProgramButtonContainer>
        <Button title="Подобрать программу тренировок" />
      </ProgramButtonContainer>

      {currentItems.map((program: TrainingProgramType) => {
